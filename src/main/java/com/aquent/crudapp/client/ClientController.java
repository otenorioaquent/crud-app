...
/**
 * Controller for handling basic com.aquent.crudapp.client management operations.
 */
@Controller
...
public class ClientController {
    ...
    /**
     * Validates and saves a new com.aquent.crudapp.client.
     * On success, the user is redirected to the listing page.
     * On failure, the form is redisplayed with the validation errors.
     *
     * @param client populated form bean for the com.aquent.crudapp.client
    ...
    /**
     * Validates and saves an edited com.aquent.crudapp.client.
     * On success, the user is redirected to the listing page.
     * On failure, the form is redisplayed with the validation errors.
     *
     * @param client populated form bean for the com.aquent.crudapp.client
     ...
     *
     * @param clientId the ID of the com.aquent.crudapp.client to be deleted
     * @return delete view populated from the com.aquent.crudapp.client record
     */
    ...
    /**
     * Handles com.aquent.crudapp.client deletion or cancellation, redirecting to the listing page in either case.
     *
